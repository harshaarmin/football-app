...
function WorldCup() {
    ...
    if (loading) return (
        <div className="flex items-center justify-center min-h-[60vh]">
            <div className="text-yellow-400 text-lg animate-pulse">Loading World Cup 2026...</div>
        </div>
    )
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-white">FIFA World Cup 2026</h2>
                        <p className="text-yellow-400 text-sm font-medium">
                            🔴 LIVE — Group Stage · June 11 – July 19, 2026
                        </p>
                    </div>
                </div>
                    ...
                    <div key={group.name} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-yellow-500 transition-colors">
                        ...
                        <div className="px-4 py-2 bg-gray-900 border-t border-gray-800">
                            <div className="flex justify-between text-xs text-gray-600">
                                <span>Top 2 qualify to Round of 32</span>
